...
import { deleteUserFailure, deleteUserStart, deleteUserSuccess, signInFailure, signInSuccess, signOutStart, updateUserFailure, updateUserStart, updateUserSuccess } from '../redux/user/userSlice'
  ...
  return (
    ...
    <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
      ...
      <input type="text" placeholder='username' id="username" className='border p-3 rounded-lg' defaultValue={currentUser.username} onChange={handleChange}/>
        ...
        <Link to={'/create-listing'} className='bg-green-700 p-3 rounded-lg hover:opacity-95 text-center text-white uppercase'>Create Listing</Link>
    </form>
